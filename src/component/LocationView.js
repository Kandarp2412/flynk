...
function LocationView() {
  ...
  const handleok = () => {
    ...
    axios
      .get(
        `http://demo.travel.webbrainstechnologies.com/api/locations_delete/${data.id}`,
      )
      .then((res1) => {
  ...
  const handleEdit = () => {
    setedit(true)
    history.push(`/location/edit/${itemId}`)
  }
    ...
    axios
      ...
      .then((res) => {
        ...
        localStorage.setItem(
          "Asset_SerialNumber",
          res.data.asset.serial_number
        )
        localStorage.setItem("Asset_Model", res.data.asset.model)
        localStorage.setItem("Asset_Manufacturer", res.data.asset.manufacturer)
        localStorage.setItem("Asset_Year", res.data.asset.year)
        localStorage.setItem("Asset_QrBarcode", res.data.asset.qr_barcode)
        localStorage.setItem("Asset_Parent", res.data.asset.parent_asset)
            ...
            {flag ? (
              ...
              >
                ...
                <div style={{ height: '200px', overflowY: 'scroll' }}>
                  ...
                  <img src={data?.asset_image} alt="img"></img>
                  <Divider />
